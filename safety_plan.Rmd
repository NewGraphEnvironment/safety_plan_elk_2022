...
The latest version of this pdf can be downloaded [here](knitr::asis_output(link_pdf)).

<br>

A zip file which includes kml (google earth) and gpx (garmin) files of the sites to be potentially assessed can be downloaded [here](knitr::asis_output(link_kml)). Georeferenced pdf maps can be accessed and downloaded [here](knitr::asis_output(link_fieldmaps)).

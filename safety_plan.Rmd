...
The latest version of this pdf can be downloaded [here](%60r%20knitr::asis_output(link_pdf)%60).

<br>

A zip file which includes kml (google earth) and gpx (garmin) files of the sites to be potentially assessed can be downloaded [here](%60r%20knitr::asis_output(link_kml)%60). Georeferenced pdf maps can be accessed and downloaded [here](%60r%20knitr::asis_output(link_fieldmaps)%60).
